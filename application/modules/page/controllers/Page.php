...
class Page extends MX_Controller {
    ...
    function index() {        
		if($this->uri->segment(2)) {
			...
			$data['pageroute'] = $this->uri->segment(2);
			...
			$this->pageroute = $this->uri->segment(2);
			$this->where = array('pageroute' => $this->pageroute);
			$data['singlepage'] = $this->common_model->getRecords($this->common_model->_webpages, $this->where, 's');
			...
			echo Modules::run('template/page', $data);
