...
class Syllabus extends MX_Controller {
    ...
    function index() {        
		if($this->uri->segment(2)) {
			...
			$data['syllabuss'] = $this->syllabuss_model->getSyllabuss();
			...
			$data['singlesyllabus'] = $this->common_model->getRecords($this->common_model->_syllabuss, $this->where, 's');
			...
			echo Modules::run('template/syllabus', $data);
