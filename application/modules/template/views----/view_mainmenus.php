...
<ul class="sf-menu mainMenu">
    ...
    <li><a href="#">প্রতিষ্ঠান সর্ম্পকিত</a>
        ...
        <ul>
            ...
            <li><a href="<?php echo base_url(); ?>page/governingbody">গভর্ণিং বডি</a></li>
            ...
            <li><a href="<?php echo base_url(); ?>page/workingmanpower">শিক্ষক ও কর্মচারীদের সৃষ্টপদ </a></li>
        </ul>
    </li>
    <li><a href="<?php echo base_url(); ?>page/About-Us">আমাদের কথা</a>
        ...
        <div class="mobnav-subarrow"></div>
        <ul>
            <li><a href="<?php echo base_url(); ?>headmastermessage/1">প্রধান শিক্ষকের বানী</a></li>
			<li><a href="<?php echo base_url(); ?>xheadteacher">সাবেক প্রধান শিক্ষকের তালিকা</a></li>
    ...
    <li><a href="#">অফিস</a>
        ...
        <ul>
			...
			<li><a href="<?php echo base_url(); ?>xstudent">পুরাতন ছাত্র ছাত্রীদের তালিকা </a></li>
			<li><a href="<?php echo base_url(); ?>teacher">শিক্ষকদের তালিকা </a></li>
			<li><a href="<?php echo base_url(); ?>xteacher">পুরাতন শিক্ষকদের তালিকা </a></li>
			<li><a href="<?php echo base_url(); ?>staff">অন্যান্য কর্মচারীদের  তালিকা </a></li>
			<li><a href="<?php echo base_url(); ?>xstaff">পুরাতন কর্মচারীদের  তালিকা </a></li>
	...
	<li><a href="<?php echo base_url(); ?>gallery">গ্যালারি</a></li>
