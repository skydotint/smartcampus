                ...
                <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                    <div class="sliderSection">
                        ...
                        <div class="schoolCorner">
                            <h2>শিক্ষক, শিক্ষার্থী ও অভিভাবক কর্নার</h2>
                            <div class="clear"></div>
            ...
            <div class="row margin15">
                <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                    <div class="headmasterQuote">
                        <h2 class="blue">প্রধান শিক্ষকের বানী</h2>
                        <div class="clear"></div>
                        ...
                        <p>
							...
							$string = $setting['headmessage'];
								...
								$trimstring = substr($string, 0, 2000). ' <a href="headmastermessage/'.$settingsid.'">বিস্তারিত...</a>';
								} else {
								$trimstring = $string;
								}
								echo $trimstring;
