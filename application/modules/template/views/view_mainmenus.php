...
<ul class="sf-menu mainMenu">
    ...
    <li><a href="<?php echo base_url(); ?>page/About-Us">আমাদের কথা</a></li>
    <li>
        <a href="<?php echo base_url(); ?>page/history">ইতিহাস</a>
        ...
        <ul>
            ...
            <li><a href="#">বিভিন্ন পাবলিক পরীক্ষার ফলাফল</a></li>
        </ul>
    </li>
    <li>
        <a href="">স্কুল কাঠামো</a>
        <div class="mobnav-subarrow"></div>
        <ul>
            <li><a href="<?php echo base_url(); ?>page/workingmanpower">কর্মরত জনবল</a></li>
            <li><a href="">ইউনিফরম ও বেতন কাঠামো</a></li> 
            <li><a href="<?php echo base_url(); ?>page/Infrastructure">ভৌত কাঠামো</a></li> 
            <li><a href="<?php echo base_url(); ?>page/vacancy">শুন্য পদ</a></li> 
        </ul>
    </li>
    <li>
        <a href="">প্রশাসনিক</a>
        ...
        <ul>
            ...
            <li><a href="<?php echo base_url(); ?>teacher">শিক্ষক/শিক্ষিকা</a></li>
            <li><a href="<?php echo base_url(); ?>xteacher">প্রাক্তন  শিক্ষকদের তালিকা </a></li>
            <li><a href="<?php echo base_url(); ?>staff">কর্মচারীদের  তালিকা </a></li>
    ...
    <li>
        ...
        <ul>
            ...
            <li><a href="<?php echo base_url(); ?>page/rules">প্রতিষ্ঠানের নিয়ম শৃঙ্খলা</a></li>
            ...
            <li><a href="">সহ শিক্ষা কার্যক্রম</a></li>
            <li><a href="">বাৎসরিক কার্যক্রম</a></li>
        </ul>
    </li>
    <li>
        <a href="">শিক্ষার্থী</a>
        ...
        <ul>
            ...
            <li><a href="">বৃত্তি প্রাপ্ত শিক্ষার্থীদের তালিকা</a></li>
            <li><a href="">প্রশংসাপত্র</a></li>
            <li><a href="">ছাড়পত্র</a></li>
            <li><a href="">প্রত্যয়নপত্র</a></li>
        </ul>
    </li>
    <li>
        <a href="">ফলাফল</a>
        <ul>
            <li><a href="">স্কুল (আভ্যন্তরীন) ফলাফল</a></li>
            <li><a href="">জে.এস.সি ফলাফল</a></li>
            <li><a href="">এস.এস.সি ফলাফল</a></li>
        </ul>
    </li>
    <li><a href="<?php echo base_url(); ?>latestnews">সংবাদ</a></li>
    <li><a href="<?php echo base_url(); ?>gallery">গ্যালারী</a></li>
    <li><a href="<?php echo base_url(); ?>page/">যোগাযোগ</a></li>
    <!--<li><a href="<?php echo base_url(); ?>page/">লগইন</a></li>-->
...
<!--<ul class="sf-menu mainMenu">
    ...
    <li><a href="#">অন্যান্য</a>
        ...
        <ul>
            ...
            <li><a href="<?php echo base_url(); ?>page/multimedia-classroom">মাল্টিমিডিয়া ক্লাসরুম</a></li>
