                    ...
                    <ul class="allstdRes  allstdResChange">
                        ...
                        foreach ($teachers as $sinteacher) {
							...
							<div class="studentChange">
                                        <a href="<?php echo base_url(); ?>teacherinfo/<?php echo $sinteacher->teacherid; ?>">
                                            <img src="<?php echo base_url(); ?>uploads/teachers/<?php echo $sinteacher->photo; ?>">
                                            <span>
												নাম : <?php echo $sinteacher->firstname; ?><br />
												পদবী : <?php echo $sinteacher->designation; ?><br />
												মোবাইল : <?php echo $sinteacher->tphone; ?>
                                            </span>
