                ...
                <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse" id="accordion1">
                    ...
                    <li class="panel">
                        ...
                        <ul id="othersLink" class="nav nav-list collapse">
                            <!--<li><a data-parent="#accordion1" href="#othersLink"><i class="icon-globe"></i> Add Transport</a></li>
                            <li><a data-parent="#accordion1" href="#othersLink"><i class="icon-globe"></i> Transports</a></li>
                            <li class="divider"></li>
                            <li><a data-parent="#accordion1" href="#othersLink"><i class="icon-globe"></i> Add Hostel</a></li>
                            <li><a data-parent="#accordion1" href="#othersLink"><i class="icon-globe"></i> Hostels</a></li> -->
                            <li class="divider"></li>
