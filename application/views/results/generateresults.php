                    ...
                    <div class="tab-content">
                        <?php foreach ($classes as $class) { $calid = $class['classid']; ?>
                            ...
                            ?>" id="<?php echo $class['classid'] ?>">
                                <h4>Add Results for class <?php echo $class['classname'] ?></h4>

                                <form class="form-horizontal form-groups-bordered validate generetaeresult" id="addroutine_<?php echo $class['classid'] ?>" action="" enctype="multipart/form-data">
                                    ...
                                    <?php } ?>
                                        ...
                                        <input id="addroutinenew_<?php echo $calid ?>" name="addroutinenew" type="submit" class="btn btn-primary" value="Generate Result" />
