<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <?php //echo form_open_multipart('adddebitajax', array('class'=>'form-horizontal form-groups-bordered validate', 'id' => 'addebitForm')); ?>
            <form class="form-horizontal form-groups-bordered validate" id="adddebitForm" action="javascript:void(0);" enctype="multipart/form-data">
                <fieldset>
					<div class="control-group">
                        ...
                        <div class="controls">
                            <select name="financialdepartments">
                                ...
                                <option value="<?php echo $department['financialdepartmentid']; ?>"><?php echo $department['financialdepartmentname']; ?></option>
                               <?php } ?>
                    ...
                    <input id="adddebitbtn" name="adddebitbtn" type="submit" class="btn btn-primary" value="Save Changes" />
